package com.technicalitiesmc.electricity.simulation.engine;
...
import com.technicalitiesmc.electricity.simulation.IElementChecker;
import com.technicalitiesmc.electricity.simulation.VoltageElement;
...
public enum SimulationEngine {
	...
	public void tick(Circuit circuit){
		...
		synchronized (circuit) {
			...
			if (ElectricityGridHandler.debug) {
