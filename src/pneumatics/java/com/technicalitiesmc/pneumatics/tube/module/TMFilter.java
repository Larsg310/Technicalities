...
public class TMFilter extends TubeModule.ContainerModule {

    private static final ResourceLocation PATH_SINGLE = new ResourceLocation(Technicalities.MODID, "block/tube/filter/single");
    // private static final ResourceLocation PATH_MASTER = new ResourceLocation(Technicalities.MODID, "block/tube/filter/single");
    // private static final ResourceLocation PATH_SLAVE = new ResourceLocation(Technicalities.MODID, "block/tube/filter/single");
    ...
    public SimpleContainer createContainer(EntityPlayer player) {
        ...
        for (int i = 0; i < filters.length; i++) {
            container.addSlotToContainer(new GhostSlotItemHandler(filterInv, i, 53 + (i % 4) * 18, 13 + (i >= 4 ? 52 : 0), false));
        }
    ...
    public GuiContainer createGUI(EntityPlayer player) {
        return new GuiFilter(createContainer(player), this, other != null);
    }
